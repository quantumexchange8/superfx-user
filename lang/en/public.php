...
return [
    ...
    "crypto_deposit_info_message_1" => "Minimum deposit amount per transaction is $50.00.",
    "crypto_deposit_info_message_2" => "Maximum deposit amount per transaction is $:maxAmount.",
