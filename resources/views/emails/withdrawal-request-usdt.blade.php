                                        ...
                                        <tr>
                                            <td class="pad" style="padding-bottom:5px;padding-left:10px;padding-right:10px;padding-top:5px;width:100%;">
                                                <div align="center" class="alignment" style="line-height:10px">
                                                    <div style="max-width: 337.5px;"><img alt="" height="auto" src="{{ asset('email/withdrawal_request_usdt/images/30_fn.jpg') }}" style="display: block; height: auto; border: 0; width: 100%; border-radius: 20px 20px 20px 20px;" title="" width="337.5"/></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
